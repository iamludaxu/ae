...
public class LoadMoreRecyclerView extends RecyclerView {
    ...
    public static final int STATUS_PREPARE = 0;//加载完
    public static final int STATUS_LOADING = 1;//加载中
    public static final int STATUS_EMPTY = -1;//无更多内容
    public static final int STATUS_ERROR = -2;//加载失败
    public static final int STATUS_DISMISS = -3;//不显示
    ...
    /**
     * 设置加载底部状态
     * @param status STATUS_PREPARE、STATUS_LOADING、STATUS_EMPTY、STATUS_ERROR、STATUS_ERROR
     */
